...
## KC 亜型 → 実装マッピング(自動生成 kc_taxonomy.gen.h)

| 亜型 | 実測数 | 実測比率 | tau_elig[s] | eta_scale |
|---|---|---|---|---|
| alpha-beta | 1,810 | 0.446 | 2.5 | 1.0 |
| alpha'-beta' | 695 | 0.171 | 0.3 | 1.5 |
| gamma | 1,557 | 0.383 | 0.8 | 1.0 |
